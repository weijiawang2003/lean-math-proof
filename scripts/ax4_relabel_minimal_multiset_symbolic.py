"""AX4 Stage 4 — minimal-symbolic relabeling of AX4 WX3-only Multiset wins.
...
Outputs:
  project/data/ax4_minimal_multiset_symbolic_labels.json
  project/data/ax4_multiset_symbolic_family_pools_meta.json
"""
...
PROBE = ROOT / "project/data/ax4_multiset_mining_probe_meta.json"
OUT_LABELS = ROOT / "project/data/ax4_minimal_multiset_symbolic_labels.json"
OUT_POOLS = ROOT / "project/data/ax4_multiset_symbolic_family_pools_meta.json"
...
def write_pools(results):
    ...
    meta = {
        ...
        "ax4_new_clean_single_shot_symbolic": clean,
    ...
    print(f"ax4_new_clean={clean} dropped={dropped} "
...
def main():
    ...
    print(f"relabeling {len(thms)} AX4 WX3-only wins")
