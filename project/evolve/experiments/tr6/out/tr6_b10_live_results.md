# TR6 B10 live results

- theorems: 137 | live: 135 | total successes: **12** | new this stage: 3
- first-success rank histogram: {1: 1, 9: 1, 2: 4, 6: 1, 3: 2, 7: 1, 4: 1, 5: 1}
...
| `Set.mapsTo_singleton` | Set | False | None | `` |
...
| `mem_lowerBounds_iff_subset_Ici` |  | False | None | `` |
