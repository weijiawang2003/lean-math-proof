# v5 autonomous research final report — v5-ns3-20260522-200134-2c809a
...
|---|---------|-----|--------|----|------|-----|---------------------|--------------|
| 1 | ns3-combined | all+priority | 36 | +5 | 1 | 1 | 0/0/0 | Nat.div_le_div_right, Nat.dvd_iff_div_mul_eq, Nat.eq_one_of_mul_eq_one_left, Nat.pow_lt_pow_iff_left, Nat.sqrt_lt |
